...
def create_model_01(input_shape=(299, 299, 3)):
    """
    ...
    model.add(Conv2D(48, 3, 3, subsample=(2, 2), activation='elu'))
    model.add(Dropout(0.1))

    model.add(Conv2D(64, 3, 3, subsample=(1, 2), activation='elu'))
    model.add(Dropout(0.1))

    # output 1, 16, 64
    model.add(Conv2D(96, 3, 3, subsample=(1, 1), activation='elu'))
    model.add(Dropout(0.1))
    ...
    model.add(Flatten())
    model.add(Dense(5376, activation='elu'))
